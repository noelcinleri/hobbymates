...
import 'package:hobby_mates/utils/responsive_screen.dart';
...
class HalfBoxField extends StatefulWidget {
  final TextEditingController controller;
  final FocusNode focusNode;
  final TextInputType keyboardType;
  final TextInputAction textInputAction;
  ...
  @override
  _HalfBoxFieldState createState() => _HalfBoxFieldState();
}

class _HalfBoxFieldState extends State<HalfBoxField> {
  double width;
  double height;
  Color focusBorderColor =  Colors.grey.shade400;
  FocusNode _focusNode = FocusNode();
